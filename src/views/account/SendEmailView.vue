        ...
        <div class="container bg-white p-5 mt-2">
            ...
            <div class="flex flex-wrap mt-4 mb-6">
                <div class="w-full md:w-2/6 px-3">
                    <TextInput 
                        label="To *"
                        placeholder="Add recipient & ADD REC"
                        v-model:input="recipientAdd"
                        inputType="text"
                        :error="''"
                    />
                </div>
                ...
                <div class=":read-only w-full md:w-3/6 px-3">
                    <TextInput
                        ...
                        placeholder="Recipient List comes here"
                        v-model:input="recipientFinal"
                        inputType="text"
                        :readOnly=true
...
<script setup>
    ...
    let recipientFinal = ref(null)
    let recipientAdd = ref(null)
    let recipientAdded = []
    ...
    const SendEmail = async () => {
        ...
        recipientAdded.forEach((recipient) => {
    ...
    const addRecipient = async () => {
        if(recipientAdd.value){
            recipientAdded.push(recipientAdd.value);
            const message = recipientAdd.value;
            const currentMessage = recipientFinal.value ? recipientFinal.value+';' : ''
            recipientFinal.value = currentMessage + message;
            recipientAdd.value = '';
        }
